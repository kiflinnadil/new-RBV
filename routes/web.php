...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/books/{id}/favorite', [BukuController::class, 'toggleFavorite'])->name('books.favorite');
    ...
    Route::prefix('akun')->name('akun.')->middleware('role:super_admin')->group(function () {
    ...
    Route::prefix('eoffice')->name('eoffice.')->middleware('role:super_admin,sekretaris,unit')->group(function () {
        // Surat Masuk
