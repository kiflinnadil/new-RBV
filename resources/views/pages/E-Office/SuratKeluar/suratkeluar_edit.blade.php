...
<div class="min-h-screen bg-[#F0F4FF]">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-8 pb-10">
        ...
        <form action="{{ route('eoffice.surat-keluar.update', $surat->id) }}"
              method="POST"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               required
                               placeholder="001/RSCH/SK/IV/2026"
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 ml-1">
                            Format: No/RSCH/SK/BulanRomawi/Tahun
                        </p>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="perihal"
                              ...
                              class="w-full bg-[#F3F4F6] rounded-xl py-3 px-5 text-sm
                                     focus:outline-none focus:ring-2 focus:ring-[#2B3A8C]
                                     resize-none">{{ old('perihal', $surat->perihal) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="keterangan"
                              ...
                              class="w-full bg-[#F3F4F6] rounded-xl py-3 px-5 text-sm
                                     focus:outline-none focus:ring-2 focus:ring-[#2B3A8C]
                                     resize-none">{{ old('keterangan', $surat->keterangan) }}</textarea>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    ...
                    <a href="{{ route('eoffice.surat-keluar.index') }}"
                       class="px-6 py-2.5 text-sm font-bold text-gray-500
                    ...
                    <button type="submit"
                            class="px-8 py-2.5 bg-[#2B3A8C] text-white text-sm
                                   font-bold rounded-xl hover:bg-blue-900
