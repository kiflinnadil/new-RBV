...
<div class="min-h-screen bg-[#F0F4FF] flex items-center justify-center px-4">
    <div class="text-center max-w-md mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="font-poppins text-8xl font-extrabold text-[#2B3A8C] mb-2">404</h1>
            <h2 class="font-poppins text-2xl font-bold text-gray-700 mb-3">Halaman Tidak Ditemukan</h2>
