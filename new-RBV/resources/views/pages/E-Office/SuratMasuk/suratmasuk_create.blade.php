            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select name="prioritas" required class="w-full bg-[#F3F4F6] rounded-xl py-3 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-[#2B3A8C]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select name="jenis" required class="w-full bg-[#F3F4F6] rounded-xl py-3 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-[#2B3A8C]">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 bg-blue-50 p-4 rounded-2xl border border-blue-100">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" name="tag_users[]" value="{{ $user->id }}" class="w-4 h-4 rounded border-gray-300 text-[#2B3A8C] focus:ring-[#2B3A8C]">
                ...
                <div>
                    <label class="block text-gray-500 text-xs sm:text-sm mb-1.5 ml-1">File Scan Surat (PDF/JPG)</label>
                ...
                <div class="flex justify-end gap-3 pt-4">
                    <a href="{{ route('eoffice.surat-masuk.index') }}" class="px-6 py-2.5 text-sm font-bold text-gray-500 hover:bg-gray-100 rounded-xl transition">Batal</a>
                    <button type="submit" class="px-8 py-2.5 bg-[#2B3A8C] text-white text-sm font-bold rounded-xl hover:shadow-lg hover:shadow-blue-200 transition">
                        Simpan & Teruskan
                    </button>
                </div>
            </div>
