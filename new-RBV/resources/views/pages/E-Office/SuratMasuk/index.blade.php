...
<div class="min-h-screen bg-[#F0F4FF] py-8">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-5">
            ...
            <form method="GET"
                action="{{ route('eoffice.surat-masuk.index') }}"
                ...
                <div class="flex-1 min-w-[160px]">
                    ...
                    <select name="status"
                        ...
                        <option value="menunggu_sekretaris"
                            {{ request('status') == 'menunggu_sekretaris' ? 'selected' : '' }}>
                            Menunggu Acc
                        </option>

                        <option value="menunggu_direktur"
                            {{ request('status') == 'menunggu_direktur' ? 'selected' : '' }}>
                            Menunggu Direktur
                        </option>

                        <option value="menunggu_kabag"
                            {{ request('status') == 'menunggu_kabag' ? 'selected' : '' }}>
                            Menunggu Kabag
                        </option>
                ...
                <div class="flex gap-2">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 bg-[#2B3A8C] text-white text-sm font-bold rounded-xl
                    ...
                    <a href="{{ route('eoffice.surat-masuk.index') }}"
                        class="px-5 py-2.5 bg-gray-100 text-gray-600 text-sm font-bold rounded-xl
                ...
                <table class="w-full text-sm">
                    ...
                    <thead>
                        ...
                        <tr class="bg-[#F8FAFF] border-b border-gray-100">
                            ...
                            <th class="text-left px-5 py-3 text-xs font-bold text-gray-500">
                                No. Agenda
                            </th>
                            ...
                            {{-- PRIORITAS --}}
                            @if(
                                in_array(auth()->user()->role, ['super_admin','sekretaris'])
                                || in_array(auth()->user()->id_jabatan, [1,2])
                            )
                            <th class="text-left px-5 py-3 text-xs font-bold text-gray-500">
                                Prioritas
                            </th>
                            ...
                            <th class="text-center px-5 py-3 text-xs font-bold text-gray-500">
                                Aksi
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-[#F8FAFF] transition">
                            ...
                            <td class="px-5 py-4">
                                <span class="font-mono text-xs font-bold text-[#2B3A8C]">
                                    {{ $surat->nomor_agenda }}
                                </span>
                            </td>
                            ...
                            <td class="px-5 py-4">
                                ...
                                @if($surat->prioritas === 'segera')
                                    ...
                                    <span class="text-[10px] px-2 py-1 rounded-lg font-semibold bg-red-100 text-red-700">
                                        🔴 Segera
                                    </span>

                                @elseif($surat->prioritas === 'sedang')

                                    <span class="text-[10px] px-2 py-1 rounded-lg font-semibold bg-yellow-100 text-yellow-700">
                                        🟡 Sedang
                                    </span>

                                @elseif($surat->prioritas === 'biasa')

                                    <span class="text-[10px] px-2 py-1 rounded-lg font-semibold bg-green-100 text-green-700">
                                        🟢 Biasa
                                    </span>

                                @else

                                    <span class="text-[10px] px-2 py-1 rounded-lg font-semibold bg-gray-100 text-gray-500">
                                        — Belum diset
                                    </span>
                            ...
                            <td class="px-5 py-4">
                                ...
                                @php
                                    ...
                                    [$bg, $tc, $label] = $statusConfig[$surat->status]
