                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-[#F8FAFF] transition">
                            ...
                            <td class="px-4 py-5 font-mono font-bold text-[#2B3A8C]">{{ $surat->nomor_surat }}</td>
                            <td class="px-4 py-5 text-gray-500 whitespace-nowrap">{{ \Carbon\Carbon::parse($surat->tanggal_keluar)->format('d/m/Y') }}</td>
                            <td class="px-4 py-5 text-gray-700 font-medium">{{ $surat->tujuan }}</td>
                            <td class="px-4 py-5 text-gray-600 truncate max-w-xs">{{ $surat->perihal }}</td>
                            <td class="px-4 py-5 text-center">
                                <a href="{{ route('eoffice.surat-keluar.show', $surat->id) }}" class="inline-block p-2.5 bg-blue-50 text-blue-600 rounded-xl hover:bg-[#2B3A8C] hover:text-white transition">
                        ...
                        @empty
                        <tr><td colspan="6" class="px-4 py-20 text-center text-gray-400">Belum ada data surat keluar.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
