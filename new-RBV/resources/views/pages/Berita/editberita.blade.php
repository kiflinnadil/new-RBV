                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="kategori"
                                ...
                                <option value="Kesehatan" {{ $berita->kategori=='Kesehatan'?'selected':'' }}>
                                    Kesehatan
                                </option>
                                ...
                                <option value="Inovasi" {{ $berita->kategori=='Inovasi'?'selected':'' }}>
                                    Inovasi
                                </option>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="w-full bg-gray-100 border-none rounded-xl py-3 px-5 focus:ring-2 focus:ring-[#2B3A8C] outline-none"
                            placeholder="Masukkan deskripsi berita">{{ $berita->deskripsi }}
                        </textarea>
