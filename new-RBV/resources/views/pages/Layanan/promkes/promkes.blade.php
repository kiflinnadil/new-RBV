    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-8 sm:py-10">
        ...
        <div class="flex items-center gap-4 py-4 border-b border-gray-200">
            ...
            <div class="flex-shrink-0 w-14 h-14">
                <img src="{{ asset('images/pdf-icon.png') }}" alt="PDF" class="w-full h-full object-contain"
                     onerror="this.outerHTML='<div class=\'w-14 h-14 bg-red-600 rounded flex flex-col items-center justify-center\'><svg xmlns=\'http://www.w3.org/2000/svg\' class=\'w-6 h-6 text-white\' fill=\'none\' viewBox=\'0 0 24 24\' stroke=\'currentColor\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z\'/></svg><span class=\'text-white text-[9px] font-bold mt-0.5\'>PDF</span></div>'">
            </div>

            <div class="flex-grow">
                <a href="{{ asset('storage/' . $item->file) }}" target="_blank"
                   class="font-bold text-[18px] text-gray-800 hover:text-[#2B3A8C] transition">
                    {{ $item->judul }}
                </a>
