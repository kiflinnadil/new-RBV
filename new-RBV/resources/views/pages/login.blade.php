...
<div class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-sm mx-4">
        <div class="backdrop-blur-md bg-white/20 border border-white/30 rounded-2xl shadow-2xl px-10 py-10">
            ...
            <h1 class="text-3xl font-bold text-white text-center mb-1 tracking-wide">
                Login
            </h1>
            <p class="text-white/80 text-sm text-center mb-8">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div class="pt-2">
                    <button 
                        type="submit"
                        class="w-full py-2.5 bg-[#1E3A8A] hover:bg-[#1e40af] text-white font-semibold rounded-lg transition duration-200 tracking-wide shadow-lg">
                        Login
                    </button>
                </div>
            </form>
