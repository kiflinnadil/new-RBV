...
<div class="bg-[#F5F7FB] min-h-screen py-16 flex items-center justify-center">
    <div class="max-w-2xl w-full px-6">
        ...
        <form action="{{ route('akun.update', $user->id_user) }}" method="POST" id="formEditAkun">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-gray-500 text-sm mb-1 ml-1">
                            Password
                            <span class="text-gray-400 font-normal text-xs">(Kosongkan jika tidak ingin mengubah)</span>
                        </label>
                        <div class="relative">
