...
<div class="min-h-screen" style="background: linear-gradient(to bottom,#E0EDFF 0%,#FFFFFF 100%);">
    ...
    <div class="max-w-7xl mx-auto px-16 py-10">
                ...
                <div class="pt-6 pb-2 flex flex-col flex-grow text-center">
                    ...
                    <div class="mt-auto px-2">
                        <button onclick="document.getElementById('modal-{{ $buku->id_buku }}').showModal()" 
                                class="block w-full py-2.5 bg-[#00A14C] font-poppins text-white text-[13px] font-bold rounded-xl hover:bg-[#008a41] transition shadow-md">
                            Detail Buku
                        </button>
                    </div>
                </div>
        ...
        <div class="flex flex-col items-center justify-center py-32 text-center">
            ...
            <p class=" font-montserrat text-2xl font-bold text-gray-400 mb-2">Belum ada buku favorit</p>
            <p class="text-gray-400 text-sm mb-8">Tambahkan buku ke favorit dengan menekan ikon bintang</p>
            <a href="{{ route('books.index') }}" 
               class=" font-poppins px-6 py-3 bg-[#00A14C] text-white font-bold rounded-lg hover:bg-emerald-700 transition">
                Jelajahi Buku
            </a>
        </div>
        @endif
